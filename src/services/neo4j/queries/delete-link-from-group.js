...
class DeleteLinkFromGroup extends CypherQuery {
    get required() {
    ...
    async perform(session, timeout, {userId, groupId, linkId}) {
        ...
        await session.writeTransaction(async (txc) => {
            ...
            if (!isMember) {
                ...
                const index = groupLinksList.indexOf(linkId);
                if (index > -1) {
                    groupLinksList.splice(index, 1);
                }
...
module.exports = new DeleteLinkFromGroup();
